...
> **定位 / Scope**:面向投资判断的**行业研究**工具——仅就**公开检索**信息梳理某产业的市场规模、产能格局、竞争态势与技术路线;主题均为主流商业工业研发(先进材料、化工、合成生物学等),不涉及任何危险或管制用途。
...
- **收口页**——常规步骤跑完自动追加一页:把各步如实标注的缺口按材料性排序,并把公开检索答不了、需访谈/内部数据才能验证的尽调维度落成清单(对谁、问什么、验证哪个判断)。
